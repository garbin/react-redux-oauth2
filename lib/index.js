...
var actions = exports.actions = {
  ...
  complete: function complete(token) {
  ...
  sync_user: function sync_user(token) {
    return function (dispatch) {
  ...
  return (0, _reactRedux.connect)(function (state) {
    ...
    _createClass(_class3, [{
      ...
      value: function handleClick(e, provider) {
        ...
        var name = 'connecting to github';
        var settings = 'scrollbars=no,toolbar=no,location=no,titlebar=no,directories=no,status=no,menubar=no,width=600,height=500';
      ...
      value: function render() {
        ...
        var rest = _objectWithoutProperties(_props3, ['oauth', 'dispatch', 'actions', 'provider']);
